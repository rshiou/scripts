...
SITE=MSAP214_QA
PATCHDESC=JAN2023
SYS_PRECHECK_CMD="python3 /usr/local/bin/opc/repo/scripts/Python/oci_db_patch.py -t DBSYS -d ocid1.dbsystem.oc1.iad.anuwcljspgm6r4ian3fvv6isxwacwzvmetkncegksd6l7jr5dlxpuoxoylta -p ocid1.dbpatch.oc1.iad.anuwcljst5t4sqqa3ihg7mp5zvgnjz454youbv3ncrqgjzgm6tyvhaektuta -a PRECHECK"
SYS_APPLY_CMD="python3 /usr/local/bin/opc/repo/scripts/Python/oci_db_patch.py -t DBSYS -d ocid1.dbsystem.oc1.iad.anuwcljspgm6r4ian3fvv6isxwacwzvmetkncegksd6l7jr5dlxpuoxoylta -p ocid1.dbpatch.oc1.iad.anuwcljst5t4sqqa3ihg7mp5zvgnjz454youbv3ncrqgjzgm6tyvhaektuta -a APPLY"
DB_PRECHECK_CMD="python3 /usr/local/bin/opc/repo/scripts/Python/oci_db_patch.py -t DB -d ocid1.database.oc1.iad.anuwcljspgm6r4iads3q5e5fks53eqjjer4nicbz4h7oy3c7ykquqgpaoz2q -p ocid1.dbpatch.oc1.iad.anuwcljst5t4sqqai4kbcz7m77xbehw3wiyikwnwtnhhnegii7uftipj5w7a -a PRECHECK"
DB_APPLY_CMD="python3 /usr/local/bin/opc/repo/scripts/Python/oci_db_patch.py -t DB -d ocid1.database.oc1.iad.anuwcljspgm6r4iads3q5e5fks53eqjjer4nicbz4h7oy3c7ykquqgpaoz2q -p ocid1.dbpatch.oc1.iad.anuwcljst5t4sqqai4kbcz7m77xbehw3wiyikwnwtnhhnegii7uftipj5w7a -a APPLY"
